...
<body>
    ...
    <div class="container">
		<div class="row">
			<h1 class="col-12">Edit this resource</h1>
		</div>
	</div>
	<div class="container" id="form">
        ...
        <div class="form-group row">
				...
				<div class="col-lg-9 col-md-12 col-sm-12">
					<input class="form-control" name="resource-title" id="resource-title" value="<?php echo $row["resource_title"]; ?>"></input>
				</div>
			</div>
			<div class="form-group row">
				<label for="resource-info" class="col-lg-3 col-md-12 col-sm-12 col-form-label text-sm-right">Resource Information:</label>
				<div class="col-lg-9 col-md-12 col-sm-12">
					<textarea class="form-control" name="resource-info" id="resource-info"><?php echo $row["resource_info"]; ?></textarea>
				</div>
			</div>
            <div class="form-group row">
				<label for="link" class="col-lg-3 col-md-12 col-sm-12 col-form-label text-sm-right">Link to Resource:</label>
				<div class="col-lg-9 col-md-12 col-sm-12">
					<input class="form-control" name="link" id="link" value="<?php echo $row["link"]; ?>"></input>
				</div>
			</div>
            <input type="hidden" name="id" value="<?php echo $_GET["id"] ?>" >
			<div class="form-group row">
				<div class="col-12" id="buttons">
					<button type="submit" class="btn btn-light" id="submit-btn">Edit Resource</button>
	...
	<div class="container">
		...
		<div class="row">
			<h4 class="col-12">Please keep your edits to this resource educational regarding zodiacs, constellations, or both.</h4>
		</div>
		<div class="row">
