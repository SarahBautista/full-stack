<?php
	...
	$error = "Please fill out all required fields.";
		...
		$statement = $mysqli->prepare("UPDATE resources SET resource_title = ?, resource_info = ?, link = ? WHERE id = ?");
		$statement->bind_param("sssi", $_POST["resource-title"], $_POST["resource-info"], $_POST["link"], $_POST["id"]);
...
<body>
    ...
    <div class="container">
		<div class="row">
			...
			<?php endif; ?>
            <?php if ($isUpdated) : ?>
				<h1 class="col-12">"<?php echo $_POST["resource-title"] ?>" was successfully edited!</h1>
            <?php endif; ?>
            <?php if (!$isUpdated) : ?>
				<h1 class="col-12">Nothing changed, so "<?php echo $_POST["resource-title"] ?>" was not edited.</h1>
			<?php endif; ?>
		</div>
        <div>
